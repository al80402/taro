...
export default function (this: webpack.loader.LoaderContext) {
  ...
  const thisLoaderIndex = loaders.findIndex(item => normalizePath(item.path).indexOf('@tarojs/taro-loader/lib/taro-component') >= 0)
...
import { createTaroComponentConfig } from '@tarojs/runtime'
import component from ${stringify(componentPath)}
${importFrameworkStatement}
var config = ${configString};
var inst = Component(createTaroComponentConfig(component, ${frameworkArgs}))
